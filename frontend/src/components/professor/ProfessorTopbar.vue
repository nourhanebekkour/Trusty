  ...
  <div class="navbar-wrapper">
    <nav class="navbar">
      ...
      <div class="navbar-right">
        <div class="notif-wrap" @click="goToNotifications">
...
const userRole = computed(() => {
  ...
  return roles[auth.user?.role] ?? 'Professeur'
})

const userAvatar = computed(() => auth.user?.photo ?? null)
