...
const form = reactive({ title: '', template: 'Template 1' })
...
.pf-card--add {
  ...
  border: 2px dashed rgba(214, 237, 232, 0.18);
  cursor: pointer;
  align-items: center;
...
.pf-card__title { font-size: 1.05rem; font-weight: 700; color: var(--color-text); margin: 0; }
...
.obj-badge--WEBDEV { background: rgba(59, 130, 246, 0.18); color: #7dd3fc; }
.obj-badge--DEVOPS { background: rgba(139, 92, 246, 0.18); color: #c4b5fd; }
.obj-badge--DATA   { background: rgba(234, 179, 8,   0.18); color: #fde047; }
.obj-badge--CYBER  { background: rgba(239, 68, 68,  0.18); color: #fca5a5; }

.tpl-label { font-size: 0.7rem; color: var(--color-text-muted); background: rgba(214, 237, 232, 0.07); padding: 2px 8px; border-radius: 6px; }
...
.status-badge--published { background: rgba(92, 140, 106, 0.2); color: #86efac; }
.status-badge--draft     { background: rgba(214, 237, 232, 0.08); color: var(--color-text-muted); }

.stat-pill { display: inline-flex; align-items: center; gap: 5px; font-size: 0.75rem; color: var(--color-text-muted); background: rgba(214, 237, 232, 0.07); padding: 3px 10px; border-radius: 20px; }
...
.btn--publish {
  display: inline-flex; align-items: center; gap: 6px;
  background: rgba(92, 140, 106, 0.18); color: #86efac;
  border: 1px solid rgba(92, 140, 106, 0.4); border-radius: 8px;
  padding: 6px 12px; font-size: 0.78rem; font-weight: 600; cursor: pointer; transition: background 0.15s;
}
.btn--publish:hover { background: rgba(92, 140, 106, 0.3); }
...
.btn--unpublish:hover { background: rgba(239, 68, 68, 0.22); }
...
.modal { background: #1A3838; border: 1px solid var(--color-border); border-radius: 14px; width: 100%; max-width: 480px; display: flex; flex-direction: column; box-shadow: 0 24px 64px rgba(0,0,0,0.5); }
...
.modal__title { font-size: 1.1rem; font-weight: 700; color: var(--color-text); margin: 0; }
.modal__close { background: none; border: none; color: var(--color-text-muted); font-size: 1.1rem; cursor: pointer; padding: 4px 8px; border-radius: 6px; transition: background 0.15s; }
.modal__close:hover { background: rgba(214, 237, 232, 0.1); }
...
.field__label { font-size: 0.8rem; font-weight: 600; color: var(--color-text-muted); text-transform: uppercase; letter-spacing: 0.05em; }
.field__input { background: #0D2B2B; border: 1px solid var(--color-border); border-radius: 8px; padding: 10px 14px; color: var(--color-text); font-size: 0.9rem; font-family: Inter, sans-serif; outline: none; transition: border-color 0.15s; width: 100%; }
...
.tpl-line { border-radius: 3px; background: rgba(214, 237, 232, 0.3); }
.tpl-line--title { height: 8px; width: 70%; }
.tpl-line--sub   { height: 5px; width: 50%; }
.tpl-line--block { height: 20px; width: 100%; margin-top: 4px; }
.template-card__label { display: block; text-align: center; font-size: 0.75rem; font-weight: 600; color: var(--color-text-muted); padding: 6px 0; background: #0D2B2B; }
...
.auto-default-title { font-size: 0.95rem; font-weight: 700; color: #86efac; margin: 0 0 4px; }
.auto-default-msg   { font-size: 0.82rem; color: rgba(214, 237, 232, 0.65); margin: 0; }

.pf-card--auto { border-color: rgba(92, 140, 106, 0.35); }
...
.tpl-showcase__name { font-size: 0.85rem; font-weight: 700; color: var(--color-text); }
.tpl-showcase__badge {
  font-size: 0.62rem; font-weight: 700;
  background: rgba(92, 140, 106, 0.2); color: #86efac;
  border: 1px solid rgba(92, 140, 106, 0.4);
  padding: 1px 7px; border-radius: 20px;
}
.tpl-showcase__desc { font-size: 0.74rem; color: var(--color-text-muted); margin: 0; line-height: 1.4; }

/* Template 1 preview — dark navy */
.tpl1-hero {
  display: flex;
  align-items: flex-start;
  gap: 8px;
