...
/* ── PALETTE ── navy/slate + gold accent ─────────────────────────────── */
const accentColor = '#5A89D8'   /* navy-400 — used for rings, dots, fills */
...
/* Inter for UI, Lora for editorial/italic text */
...
const visibleProjects = computed(() => projects.slice(projectsIdx.value, projectsIdx.value + 3))
