...
export const creerBadge = async (req, res) => {
    ...
    try {
        const nouveauBadge = await badgesService.creerBadge(req.body);
...
export const listerBadges = async (req, res) => {
    ...
    try {
        const resultat = await badgesService.recupererTousLesBadges(req.query);
...
export const obtenirBadge = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        const badge = await badgesService.recupererBadgeParId(id);
        if (!badge) {
...
export const modifierBadge = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        const badgeModifie = await badgesService.modifierBadge(id, req.body);
...
export const supprimerBadge = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        await badgesService.supprimerBadge(id);
...
export const uploadIcone = async (req, res) => {
    ...
    try {
        ...
        const result = await badgesService.mettreAJourIcone(id, req.file, req.user.id);
...
export const attribuerBadgeEtudiant = async (req, res) => {
    ...
    try {
        ...
        const attribution = await badgesService.attribuerBadge(id_etudiant, id);
...
export const retirerBadgeEtudiant = async (req, res) => {
    ...
    try {
        ...
        await badgesService.retirerBadge(id_etudiant, id);
...
export const listerBadgesEtudiant = async (req, res) => {
    ...
    try {
        ...
        const resultat = await badgesService.recupererBadgesEtudiant(id_etudiant);
...
export const listerEtudiantsDuBadge = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        const resultat = await badgesService.recupererEtudiantsDuBadge(id);
