...
routeur.get('/a-valider', requireRole('PROFESSEUR'), activiteController.listerActivitesAValider);
...
routeur.post('/:id/valider', requireRole('PROFESSEUR'), activiteController.validerActivite);
